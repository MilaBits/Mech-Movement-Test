...
////// Emissive:
                ...
                float3 emissive = (_Emission*node_544);
                ...
                float3 finalColor = emissive + (_LightColor0.rgb*_Ramp_var.rgb*attenuation);
